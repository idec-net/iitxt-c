...
Сборка и установка - make. После первого запуска любой из утилит правите файл config.cfg: там указывается адрес станции, строка авторизации (пароль) и подписки на эхоконференции. Вся конфигурация и база сообщений находится в ```$HOME/.local/share/iitxt-c/```.
